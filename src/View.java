...
public class View implements Runnable{
    ...
    public View() {
        ...
        for(int i = 0; i < 2; i++) {
            if(i < 1){
                title[i] = new JLabel("Elevator ", JLabel.CENTER);
        ...
        outbutton.panel.setBounds((Const.elevatorwide+Const.elevatorspace)*1, Const.space+Const.titleheight, Const.outsidewide, Const.outsideheight);
